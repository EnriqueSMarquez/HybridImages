function varargout = CVGUI1_export2(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CVGUI1_export2_OpeningFcn, ...
                   'gui_OutputFcn',  @CVGUI1_export2_OutputFcn, ...
                   'gui_LayoutFcn',  @CVGUI1_export2_LayoutFcn, ...
                   'gui_Callback',   []);
...
function CVGUI1_export2_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = CVGUI1_export2_OutputFcn(hObject, eventdata, handles) 
...
switch val
    ...
    case 'LETTERS'
        ...
        image1 = image1(winSize:image1Size(1,1,1)-winSize-1,winSize:image1Size(1,2,1)-winSize-1,:) - newImage2 +125;
        ...
        %SHOW IMAGE IN GRAPH
        imshow(image1, 'Parent', handles.graph1);
...
function h1 = CVGUI1_export2_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '\\filestore.soton.ac.uk\users\esm1g14\mydocuments\MATLAB\CV\Assignment1\CVGUI1_export2.m', ...
    'lastFilename', '\\filestore.soton.ac.uk\users\esm1g14\mydocuments\MATLAB\CV\Assignment1\CVGUI1.fig');
...
'Position',[135.6 -2.30769230769231 211.8 53.5384615384615],...
'Resize','off',...
...
'Parent',h1,...
'Units','characters',...
'Position',[2.5 3.82692307692308 161.5 46.1666666666667],...
...
'LineWidth',0.5,...
'Margin',3,...
'Position',[0.5 1.01083333333333 1.00005459937205],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',3,...
'Position',[0.498760842627014 -0.0391666666666668 1.00005459937205],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',3,...
'Position',[-0.0353159851301115 0.4975 1.00005459937205],...
'Rotation',90,...
'String',blanks(0),...
'Interpreter','tex',...
'VerticalAlignment','bottom',...
...
'LineWidth',0.5,...
'Margin',3,...
'Position',[-0.016728624535316 1.07416666666667 1.00005459937205],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'Title','CONTROL PANEL',...
'Clipping','on',...
'Position',[174.6 2.61538461538462 37 49.1538461538462],...
'Tag','uipanel1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Callback',@(hObject,eventdata)CVGUI1_export2('maindroplist_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',12,...
'Position',[2.66666666666667 43.5705128205128 28 3.25],...
'String',{  'CATDOG'; 'BIRDPLANE'; 'SUBFISH'; 'MOTOBICY'; 'LETTERS' },...
'Style','popupmenu',...
'Value',1,...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)CVGUI1_export2('maindroplist_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','maindroplist');
...
'Clipping','on',...
'Position',[1.6 4.69230769230769 25 19.6153846153846],...
...
'Units','characters',...
'Callback',mat{1},...
'Position',[1.83333333333333 16.1987179487179 15.6666666666667 1.91666666666667],...
'String','1',...
'Style','radiobutton',...
'Value',1,...
'Tag','sigma1',...
...
'Units','characters',...
'Callback',mat{2},...
'Position',[1.66666666666667 14.1987179487179 15.6666666666667 1.91666666666667],...
'String','3',...
'Style','radiobutton',...
'Tag','sigma3',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{3},...
'Position',[1.66666666666667 12.0320512820513 15.6666666666667 1.91666666666667],...
'String','5',...
'Style','radiobutton',...
'Tag','sigma5',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{4},...
'Position',[2 9.86538461538461 15.6666666666667 1.91666666666667],...
'String','7',...
'Style','radiobutton',...
'Tag','sigma7',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{5},...
'Position',[2 7.78205128205127 15.6666666666667 1.91666666666667],...
'String','9',...
'Style','radiobutton',...
'Tag','sigma9',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{6},...
'Position',[2.16666666666667 5.61538461538461 15.6666666666667 1.91666666666667],...
'String','15',...
'Style','radiobutton',...
'Tag','sigma15',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{7},...
'Position',[2 3.61538461538461 15.6666666666667 1.91666666666667],...
'String','21',...
'Style','radiobutton',...
'Tag','sigma21',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'Callback',mat{8},...
'Position',[1.83333333333333 1.69871794871794 15.6666666666667 1.91666666666667],...
'String','31',...
'Style','radiobutton',...
'Tag','sigma31',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Title','Image',...
'Clipping','on',...
'Position',[1.6 34.2307692307692 33.6 9.84615384615385],...
...
'Callback',mat{9},...
'FontSize',12,...
'Position',[1.6 5.69230769230769 24.4 1.92307692307692],...
'String','Hybrid Image',...
'Style','radiobutton',...
'Value',1,...
'Tag','hybridButton',...
...
'Parent',h18,...
'Units','characters',...
'Callback',@(hObject,eventdata)CVGUI1_export2('highPassButton_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',12,...
'Position',[1.4 3.07692307692308 29.6 1.92307692307692],...
...
'Callback',mat{10},...
'FontSize',12,...
'Position',[1.6 0.615384615384615 28.6 1.92307692307692],...
...
'Parent',h7,...
'Units','characters',...
'Callback',@(hObject,eventdata)CVGUI1_export2('changeImagesButton_Callback',hObject,eventdata,guidata(hObject)),...
'Position',[3.16666666666667 31.5705128205128 21.8333333333333 1.91666666666667],...
...
'Parent',h7,...
'Units','characters',...
'Callback',@(hObject,eventdata)CVGUI1_export2('multipleImagesButton_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',12,...
'Position',[0.8 26.9230769230769 34.2 3.69230769230769],...
...
'Parent',h7,...
'Units','characters',...
'Callback',@(hObject,eventdata)CVGUI1_export2('runButton_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',13,...
'Position',[4.16666666666667 1.48717948717949 20.8333333333333 3],...
'String','RUN',...
'Tag','runButton',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Units','characters',...
'FontSize',16,...
'Position',[42 50.8269230769231 85.6666666666667 2.16666666666666],...
'String','COMPUTER VISION FIRST ASSIGNMENT',...
'Style','text',...
'ButtonDownFcn',@(hObject,eventdata)CVGUI1_export2('text2_ButtonDownFcn',hObject,eventdata,guidata(hObject)),...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)CVGUI1_export2('text2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','text2');
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % CVGUI1_EXPORT2('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % CVGUI1_EXPORT2(...)
